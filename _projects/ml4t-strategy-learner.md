...
![Strategy learner cumulative return experiment](/assets/images/projects/ml4t-p8-experiment1.png)

*Cumulative portfolio value for the learned strategy versus the manual benchmark across the in-sample period. The learned strategy consistently navigates volatile periods with greater agility.*
...
![Impact sensitivity analysis](/assets/images/projects/ml4t-p8-experiment2-1.png)
...
*The manual strategy's equity curve, shown above, exhibits cleaner entry and exit signals but misses the intra-period opportunities that the learned strategy captures under low-friction conditions.*
...
Algorithmic trading is one of the most demanding real-world applications for machine learning: the data is noisy and non-stationary, the "ground truth" changes as other market participants adapt, and the consequences of model failure are immediate and financial. The practices established in this project — baseline construction, in-sample/out-of-sample separation, sensitivity analysis, and risk-adjusted metrics — are the same practices used in professional quantitative research.
